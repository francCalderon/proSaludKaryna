...
export interface ApiHomePageHomePage extends Schema.SingleType {
  ...
  attributes: {
    ...
    benefits: Attribute.Component<'shared.benefit', true>;
    createdAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
    ...
    > &
      Attribute.Private;
    finalCtaText: Attribute.Text;
    finalCtaTitle: Attribute.String &
      Attribute.SetMinMaxLength<{
        maxLength: 200;
      }>;
    heroButtonLink: Attribute.String & Attribute.DefaultTo<'/contacto'>;
    heroButtonText: Attribute.String &
      Attribute.SetMinMaxLength<{
        maxLength: 50;
      }> &
      Attribute.DefaultTo<'Solicitar informaci\u00F3n'>;
...
export interface ApiServiceService extends Schema.CollectionType {
  ...
  info: {
    description: 'Servicios de enfermer\u00EDa ofrecidos';
  ...
  attributes: {
    ...
    iconName: Attribute.String &
      ...
      Attribute.DefaultTo<'stethoscope'>;
...
export interface ApiTestimonialTestimonial extends Schema.CollectionType {
  ...
  info: {
    description: 'Testimonios de pacientes y familiares';
